...
<form method="post" enctype="multipart/form-data" class="form-profile">
	<div class="wrapper-content">
		...
		<dl class="form-item">
			...
			<dd>
				<input type="text" name="profile_name" id="profile_name" value="{$oUserCurrent->getProfileName()|escape:'html'}" class="input-text input-width-250" style="width:234px">
			</dd>
		</dl>
		...
		<dl class="form-item">
			...
			<dd>
				<select name="profile_sex" id="profile_sex" class="input-width-250" style="width:248px">
		...
		<dl class="form-item">
			...
			<dd>
				<select name="profile_birthday_day" style="width: 72px; margin-right: 4px;">
				...
				<select name="profile_birthday_month" style="width: 90px; margin-right: 4px;">
	...
	<div class="wrapper-content">
     ...
     <div class="button2 button-primary l-b">
        <em></em><span></span><button type="submit"  name="submit_profile_edit"/>{$aLang.settings_profile_submit}</button>
     </div>
