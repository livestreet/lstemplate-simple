...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="button2">
        <em></em><span></span><input type="submit" value="{$aLang.send_message}" name="submit_talk_add" />
    </div>
    <div class="button2">
        <em></em><span></span><input type="submit" name="submit_preview" value="{$aLang.topic_create_submit_preview}" onclick="jQuery('#text_preview').parent().show(); ls.tools.textPreview('talk_text',false); return false;" />
    </div>
