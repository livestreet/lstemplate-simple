<table class="table blog-list-table table-people">
	<thead>
		<tr>
			...
			{if $oUserCurrent}<td align="center" width="100px"></td>{/if}
		...
		{foreach from=$aBlogs item=oBlog}
			...
			<tr>
				<td>
					...
					<p>{$aLang.blogs_owner}: <a href="{router page='profile'}{$oUserOwner->getLogin()}/" class="username">{$oUserOwner->getLogin()}</a></p>
				</td>
				{if $oUserCurrent}
					<td align="center">
